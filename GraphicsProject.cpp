// GraphicsProject.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
public:
	...
	{
		// Load object file
		meshCube.LoadFromObjectFile("model.txt");
...
{
	olcEngine3D demo;
	if (demo.ConstructConsole(256, 170, 4, 4))
		demo.Start();
	return 0;
}
